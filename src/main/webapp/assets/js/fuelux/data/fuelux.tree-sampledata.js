...
tree_data_2['pictures']['additionalParameters'] = {
	'children' : {
        ...
        'addto' : {name: 'addto', type: 'item', 'icon-class':'pink'},
        'addto1' : {name: 'addto1', type: 'item', 'icon-class':'pink'},
        'addto2' : {name: 'addto2', type: 'item', 'icon-class':'pink'},
        'addto3' : {name: 'addto3', type: 'item', 'icon-class':'pink'}
	}
}
