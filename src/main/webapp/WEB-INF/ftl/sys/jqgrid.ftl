...
<head>
    ...
    <link rel="stylesheet" href="${host!}/assets/css/jquery-ui-1.10.3.full.min.css"/>
    <link rel="stylesheet" href="${host!}/assets/css/datepicker.css"/>
    <link rel="stylesheet" href="${host!}/assets/css/ui.jqgrid.css"/>
...
<script src="${host!}/assets/js/date-time/bootstrap-datepicker.min.js"></script>
<script src="${host!}/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
<script src="${host!}/assets/js/jqGrid/i18n/grid.locale-en.js"></script>
